...
def landing_page(request):
    # hace que aparezca por defecto la categoría popular
    category = request.GET.get('category','popular')
    search_query = request.GET.get("search","")
    page = int(request.GET.get("page",1))
    next_page = page + 1

    #URL base que aparece en el listado general
...
def movie_detail(request, movie_id):
    ...
    try:
        ...
        movie_data=[]
        error_message = "Algo salió mal con la peli"
    ...
    try:
        ...
        credits_data=[]
        error_message = "Algo salió mal con los créditos."
